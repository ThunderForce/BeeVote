...
lang = {
	'en': {
		...
		'bug_report_message':"Report a bug and help us improve your user experience",
		'create':"Create",
		...
		'bug_report_message':"Segnala un problema e aiutaci a migliorare la tua esperienza",
